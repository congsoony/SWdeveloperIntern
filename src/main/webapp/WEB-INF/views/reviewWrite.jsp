		...
		<div class="header fade">
			<header class="header_tit">
				<h1 class="logo">
				  ...
				  <a href="javascript:window.history.back()" class="btn_my"> <span title="예약확인">예약확인</span> </a>
			</header>
		</div>
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					...
					<h2><span class="title" id="title">클림트 인사이드</span></h2>
				</div>
				<!-- 리뷰 별점 -->
				<div class="write_act">
					...
					<div class="review_rating rating_point">
						<div class="rating" id="star_rating">
							...
							<span class="star_rank gray_star" id="star_value">0</span>
						</div>
					</div>
				</div>
				<!-- //리뷰 별점 -->
				...
				<div class="review_contents write">
					...
					<a class="review_write_info" id="review_write_info">
						<span class="middot">
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<div class="guide_review">
							<span id="typing_length">0</span>/400
							<span>(최소5자이상)</span>
						</div>
					</div>
				...
				<!-- 리뷰 등록 -->
				<div class="box_bk_btn" id="submit_btn">
