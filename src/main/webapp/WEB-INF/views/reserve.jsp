            ...
            <div class="ct_wrap">
                ...
                <div class="group_visual">
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" id="product_img"> <span class="img_bg"></span>
                ...
                <div class="section_booking_ticket">
                    <div class="ticket_body" id="ticket_body">
                    </div>
                </div>
    ...
    <jsp:include page="/WEB-INF/views/include/footer.jsp"/>
      <script type="rv-template" id="count_script_template">
        <div class="qty">
            ...
            <div class="qty_info_icon"> <strong class="product_amount"> <span>{{priceTypeName}}</span> </strong> <strong class="product_price"> <span class="price" data-price="{{price}}">{{price}}</span> 
                <span class="price_type">원</span> </strong> <em class="product_dsc">{{price}}원 ({{discountRate}}% 할인가)</em> </div>
        </div>
	</script>
    	<script
