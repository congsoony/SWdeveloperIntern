...
<body>
	<div id="container">
		...
		<script type="rv-template" id="confirmed_script_template">
			<article class="card_item" data-reservationInfoId={{reservationInfoId}} data-displayInfoId={{displayInfoId}}>
					...
					<div class="card_body">
						...
						<div class="middle">
							<div class="card_detail">
								...
								<div class="booking_cancel">
									<a><button class="btn" id="review_btn" data-reservationInfoId={{reservationInfoId}} onclick="myReserveObj.moveReviewPage(event);"><span>예매자 리뷰 남기기</span></button></a>
								</div>
							</div>
						</div>
						<div class="right"></div>
		...
		<script src="js/myreservation/myReserveObj.js"></script>
